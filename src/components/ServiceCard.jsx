...
export default function ServiceCard({ title, description, iconPath, onBook }) {
  return (
    <div className="service-card" onClick={onBook}>
      ...
      <button className="btn btn-text" style={{ alignSelf: 'flex-start', paddingLeft: 0, marginTop: 'auto' }}>
        Book now
